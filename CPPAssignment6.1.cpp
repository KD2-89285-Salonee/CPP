...
class Tape : public Product 
{
    ...
    void displaydata()const override
    {
        ...
        cout << "Tape ID: "<< id << ", Title: " << title << ", Artist: " << artist << ", Price: " << price << ", Discounted Price: " << calculatediscount() << endl;
    }
    ...
    int main()
    {
        ...
        for (int i = 0; i < 3; i++) {
            arr[i]->displaydata();
            totalbill = totalbill+arr[i]->calculatediscount();
        }
